...
public class Leetcode57 {
    public int[][] insert(int[][] intervals, int[] newInterval) {
        ...
        int [][] newSize = Arrays.copyOf(intervals, intervals.length + 1);

        newSize[intervals.length] = newInterval;

        return merge(newSize);
    }
    ...
    public static void main(String[] args) {
        ...
        int[] newInterval = {2, 5};
        int[][] result = l.insert(intervals, newInterval);
